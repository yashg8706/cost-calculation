	...
	describe("Test suite for function calculateCost(totalUnits, pricePerUnit, state)", function(){
		describe("Test to pass", function(){
			...
			it("should return \" 7555.68\" if totalUnits is 3600, pricePerUnit is 2.25 and state is MI", function(){
				expect(calculateCost(3500,2.25,"MI")).toEqual(7555.68);
			});
		});
		...
		describe("Test to fail", function(){
			...
			it("should return \" Invalid province/state code length.\" if totalUnits is 500, pricePerUnit is 1 and state is 22", function(){
				expect(calculateCost(500,1,22)).toEqual("Invalid province/state code length.");
			});
